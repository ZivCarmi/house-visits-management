...
export default function UpdatePasswordForm({
    ...
    const updatePassword = (e: React.SubmitEvent<HTMLFormElement>) => {
        e.preventDefault();
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium">עדכן סיסמא</h2>

                <p className="mt-1 text-sm">
                    וודאו שהחשבון שלך משתמש בסיסמא ארוכה ואקראית כדי לשמור על
                    אבטחה.
                </p>
            </header>
