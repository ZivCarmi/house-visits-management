...
export default function GoogleCalendarIntegration({
    ...
    const handleDisconnect = () => {
        if (
            !confirm(
                "האם אתה בטוח שברצונך לנתק את יומן Google? פעולה זו לא תמחק אירועים קיימים ביומן.",
            )
        ) {
            return;
        }
    ...
    return (
        <div className={className}>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
                חבר שירותים חיצוניים לשיפור חוויית השימוש
            </p>
                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between gap-4">
                            <div>
                                <h4 className="font-medium">יומן Google</h4>
                                <p className="text-sm text-muted-foreground">
                                    {isConnected
                                        ? "יומן Google שלך מחובר"
                        ...
                        <div className="text-sm">
                            חיבור היומן מאפשר לתאם ביקורים ישירות מתוך המערכת.
                            בעת יצירת ביקור, ייווצר אירוע ביומן שלך עם תאריך,
                            שעה ופרטי המטופל — כך שכל התיאומים מרוכזים במקום
                            אחד.
                        </div>
                    </div>
                </div>
