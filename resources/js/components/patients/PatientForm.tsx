...
export function PatientFormFields({
    ...
    return (
        <>
            <Field aria-invalid={errors.full_name ? "true" : "false"}>
            ...
            <Field aria-invalid={errors.id_number ? "true" : "false"}>
            ...
            <Field aria-invalid={errors.address ? "true" : "false"}>
            ...
            <Field aria-invalid={errors.phone ? "true" : "false"}>
            ...
            <Field aria-invalid={errors.feeding_type ? "true" : "false"}>
                ...
                <Select
                    ...
                    aria-invalid={errors.feeding_type ? "true" : "false"}
                    aria-required={true}
                    required
                >
            ...
            <Field aria-invalid={errors.last_visit_date ? "true" : "false"}>
                ...
                <Popover>
                    <PopoverTrigger className="w-full" asChild>
                        <Button
                            ...
                            aria-invalid={
                                errors.last_visit_date ? "true" : "false"
                            }
                        >
            ...
            <Field aria-invalid={errors.followup_frequency ? "true" : "false"}>
                ...
                <Select
                    ...
                    aria-invalid={errors.followup_frequency ? "true" : "false"}
                    aria-required={true}
                    required
                >
                    <SelectTrigger id="followup_frequency" className="w-full">
